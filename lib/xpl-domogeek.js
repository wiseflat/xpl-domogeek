        ...
        _httpRequest: function(type, url, callback){
                ...
                return http.get(url, function(res) {
                        ...
                        res.on('end', function() {
                                ...
                                //data.current = current_tmp.keys(o).map(function(k) { return o[k] });
                                
                                //data.current = [];
                                //data.current = JSON.parse(body);
                                /*for(var x in current_tmp){
                                  data.current.push(current_tmp[x]);
                                }*/
                                for (var key in current_tmp)
                                     //alert(key + ' is ' + current_tmp[key]);
                                    data.current.push = {key : current_tmp[key]};

                                //data.current = (current_tmp).toArray();
